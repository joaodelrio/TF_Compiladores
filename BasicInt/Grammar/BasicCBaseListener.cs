...
public partial class BasicCBaseListener : IBasicCListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterLib([NotNull] BasicCParser.LibContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="BasicCParser.lib"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitLib([NotNull] BasicCParser.LibContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterTypeCast([NotNull] BasicCParser.TypeCastContext context) { }
	/// <summary>
